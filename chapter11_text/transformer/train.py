# train.py
import chapter11_text.transformer.config as config
import chapter11_text.transformer.dataset as dataset
import chapter11_text.transformer.engine as engine
...
from chapter11_text.transformer.model import BERTBaseUncased
...
def train():
    ...
    # fetch a scheduler
    # you can also try using reduce lr on plateu
