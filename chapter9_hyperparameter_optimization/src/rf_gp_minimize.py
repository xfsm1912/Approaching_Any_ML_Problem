...
def optimize(params, param_names, x, y):
    ...
    return -1 * np.mean(fold_accuracy)
...
if __name__ == '__main__':
    ...
    param_space = [
        # max_depth is an interger between 3 and 10
    ...
    # by using functools partial, i am creating
    # a new function which has same parameters as the
    # optimize function except fo the fact that
    # only one param, i.e. the 'params' parameters is
    ...
    # now we call gp_minimize for scikit-optimize
